...
export class AuthService{
    ...
    autoLogin(){
        ...
        if(loadedUser.token){
            ...
            // console.log('user Data',userData,userData._tokenExpirationDate,new Date(userData._tokenExpirationDate));
    ...
    logout(){
        ...
        localStorage.clear();
        // both work the same since userData is the only thing we store
